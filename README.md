...
Laravel TestBench requires [PHP](https://php.net) 7.1 or 7.2, and supports [PHPUnit](https://phpunit.de/) 6. This particular version supports Laravel 5.5 or 5.6 only.
