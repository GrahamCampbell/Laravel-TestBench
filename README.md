...
Laravel TestBench requires [PHP](https://php.net) 7.1 - 7.3, and supports [PHPUnit](https://phpunit.de/) 6 or 7. This particular version supports Laravel 5.5 - 5.8 only.
